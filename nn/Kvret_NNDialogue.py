...
from loader.Kvret_DataReader import *
...
class NNDial(object):
    ...
    def testNet(self):
        ...
        print 35*'#' + '  Metrics ' + 35*'#'
        print 80*'#'
        print 'Venue Match Rate     : %.2f%%' % (100*stats['vmc']/float(len(testset)))
        print 'Task Success Rate    : %.2f%%' % (100*stats['success']/float(len(testset)))
